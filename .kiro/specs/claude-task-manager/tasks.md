...
- [ ] 47. 勤務リズム取得機能（get_working_cadence）の実装
- [ ] 47.1 WorkingCadenceService基盤の実装
  - [ ] **テスト**: `tests/unit/working-cadence.test.ts`
  - [ ] `WorkingCadenceService` クラスの作成
...
- **完了タスク**: 46タスク（OAuth含む）
- **未実装タスク**: 1タスク（47. get_working_cadence）
