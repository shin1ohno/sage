...
2. 時間を見積もるとき、システムは設定された時間マッピングを使用すること：
   ...
   - Complex（複雑）: 75分
   - Project（プロジェクト）: 175分
   - 注: 全ての基本時間は25分の倍数とすること
3. 修飾子（タスクの長さ、ミーティング、デバッグ等）を適用した後、システムは最終的な見積もり時間を最も近い25分の倍数に丸めること
4. 丸め処理により、全ての見積もり結果は25分の倍数（25, 50, 75, 100, 125, 150, 175, 200分など）となること
5. 利用可能な時間枠を見つけるとき、システムはユーザーのカレンダーを確認すること
6. カレンダーを確認するとき、システムは設定された勤務時間を尊重すること
7. 時間枠を提案するとき、システムは深い作業日と会議の多い日を考慮すること
8. 競合がない場合、システムは理由付きで最適な時間枠を提案すること
