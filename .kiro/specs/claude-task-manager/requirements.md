...
2. iOS/iPadOSで動作するとき、システムはネイティブCalendar統合を優先して使用すること
3. macOSで動作するとき、システムはAppleScript経由でCalendar.appから情報を取得すること
4. カレンダーを分析するとき、システムは空いている時間枠を識別すること
5. 時間枠を評価するとき、システムは設定された深い作業日を考慮すること
6. 会議の多い日が設定されているとき、システムはそれらの枠をあまり適さないとマークすること
7. 競合が検出されたとき、システムはその時間帯を除外すること
8. 枠を提案するとき、システムは適合性でランク付けし、使用したカレンダー統合方法を明記すること
9. カレンダーアクセスが利用できない場合、システムは手動入力や代替手段を提案すること
...
2. iOS/iPadOSで動作するとき、システムはネイティブ統合を優先して使用すること
3. macOSで動作するとき、システムはAppleScript統合を使用すること
4. リマインダーを作成するとき、システムは設定されたリマインダーリストを使用すること
5. リマインダーが作成されたとき、システムは適切な期限日とアラームを設定すること
6. 作成が失敗したとき、システムはエラー詳細と使用した統合方法を提供すること
