...
- [ ] 3. Create RRULE validation utilities
...
- [ ] 4. Create describeRecurrence utility
...
- [ ] 5. Add Zod schema for recurrence validation
...
- [ ] 6. Add unit tests for recurrence validator
...
- [ ] 7. Extend GoogleCalendarService.createEvent for recurrence
...
- [ ] 8. Update convertGoogleToCalendarEvent for recurrence
  - File: `src/types/google-calendar-types.ts`
...
- [ ] 9. Add scope parameter to GoogleCalendarService.updateEvent
  - File: `src/integrations/google-calendar-service.ts`
...
- [ ] 10. Implement updateSingleInstance logic
  - File: `src/integrations/google-calendar-service.ts`
...
- [ ] 11. Implement updateAllEvents logic
  - File: `src/integrations/google-calendar-service.ts`
...
- [ ] 12. Implement splitAndUpdateSeries for thisAndFuture
  - File: `src/integrations/google-calendar-service.ts`
...
- [ ] 13. Add scope parameter to GoogleCalendarService.deleteEvent
  - File: `src/integrations/google-calendar-service.ts`
  - Add optional `scope?: RecurrenceScope` parameter (backward compatible)
...
- [ ] 14. Implement delete with scope logic
  - File: `src/integrations/google-calendar-service.ts`
...
- [ ] 15. Extend CalendarSourceManager for recurrence routing
...
- [ ] 16. Extend handleCreateCalendarEvent for recurrence
...
- [ ] 17. Extend handleUpdateCalendarEvent for scope
  - File: `src/tools/calendar/handlers.ts`
...
- [ ] 19. Update create_calendar_event in src/index.ts
  - File: `src/index.ts`
...
- [ ] 20. Update create_calendar_event in mcp-handler.ts
...
- [ ] 21. Update update_calendar_event tool definition
...
- [ ] 22. Update delete_calendar_event in src/index.ts
  - File: `src/index.ts`
...
- [ ] 23. Update delete_calendar_event in mcp-handler.ts
  - File: `src/cli/mcp-handler.ts`
  - Add `deleteScope` parameter to delete_calendar_event schema
  - Update tool description for recurring events
...
- [ ] 25. Add handler recurrence tests
...
- [ ] 27. Add GoogleCalendarService recurrence tests
...
- [ ] 28. Add integration tests for recurring events
...
- [ ] 29. Update TROUBLESHOOTING.md for recurrence
